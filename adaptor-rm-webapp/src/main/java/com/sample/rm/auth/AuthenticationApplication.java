...
import com.sample.rm.exception.UnauthorizedException;
...
public class AuthenticationApplication implements Application {
    ...
    public final static String APPLICATION_NAME = "RM Tool";
    public final static String OAUTH_REALM = "RM Tool";
    protected final static String APPLICATION_CONNECTOR_SESSION_ATTRIBUTE = "com.sample.rm.auth.ApplicationConnector";
    protected final static String APPLICATION_CONNECTOR_ADMIN_SESSION_ATTRIBUTE = "com.sample.rm.auth.AdminSession";
     ...
     */
    public void loginWithBasicAuthentication(HttpServletRequest request) throws UnauthorizedException {
        String authorizationHeader = request.getHeader(AUTHORIZATION_HEADER);
        if (authorizationHeader == null || "".equals(authorizationHeader)) {
            throw new UnauthorizedException("No basic authentication header identified in request.");
        }
