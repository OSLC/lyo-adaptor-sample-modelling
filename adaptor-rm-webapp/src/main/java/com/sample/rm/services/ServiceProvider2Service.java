...
@Path("serviceProviders2")
public class ServiceProvider2Service
{
    ...
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getServiceProvider2(httpServletRequest, serviceProviderId);
    }
    ...
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getServiceProvider2(httpServletRequest, serviceProviderId);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/sample/rm/serviceprovider2.jsp");
        try {
