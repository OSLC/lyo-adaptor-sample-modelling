...
public class TestScriptService
{
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aTestScript != null) {
            ...
            httpServletRequest.setAttribute("aResource", aTestScript);
            httpServletRequest.setAttribute("resourceTypeName", Oslc_qmDomainConstants.TESTSCRIPT_LOCALNAME);
            httpServletRequest.setAttribute("shapeUri", UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(OslcConstants.PATH_RESOURCE_SHAPES).path(Oslc_qmDomainConstants.TESTSCRIPT_PATH).build());
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aTestScript != null) {
            ...
            try {
                httpServletRequest.setAttribute("resourceTitle", aTestScript.toString());
                ArrayList<String> getterMethodNames = new ArrayList<String>(Arrays.asList("getTitle", "getDescription", "getExecutionInstructions", "getCreator", "getCreated"));
                // Start of user code getTestScriptAsHtmlSmallPreview_setResourceGetterMethods
                //TODO: modify the set of attributes to show in the preview
                // End of user code
                String oslcPreviewDataSetAsString = PreviewFactory.getPreviewAsJsonString(aTestScript, getterMethodNames, false);
            ...
            httpServletRequest.setAttribute("previewId", "testscripts-small-preview");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aTestScript != null) {
            ...
            try {
                httpServletRequest.setAttribute("resourceTitle", aTestScript.toString());
                ArrayList<String> getterMethodNames = new ArrayList<String>(Arrays.asList("getTitle", "getDescription", "getExecutionInstructions", "getCreator", "getCreated"));
                // Start of user code getTestScriptAsHtmlLargePreview_setResourceGetterMethods
                //TODO: modify the set of attributes to show in the preview
                // End of user code
                String oslcPreviewDataSetAsString = PreviewFactory.getPreviewAsJsonString(aTestScript, getterMethodNames, true);
                httpServletRequest.setAttribute("resourcePreviewDataSet", oslcPreviewDataSetAsString);
            } catch (Exception e) {
                log.error("Could not handle largePreview", e);
                throw new WebApplicationException("Could not handle largePreview", e);
            }
            httpServletRequest.setAttribute("previewId", "testscripts-large-preview");
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/sample/rm/resourcepreview.jsp");
            httpServletResponse.addHeader(ServerConstants.HDR_OSLC_VERSION, ServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
