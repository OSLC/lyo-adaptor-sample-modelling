...
// End of user code
@OslcService(RMToolConstants.REQUIREMENTS_MANAGEMENT_DOMAIN)
@Path("serviceProviders/{serviceProviderId}/requirements")
public class RequirementService
{
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final Requirement aRequirement = RMToolManager.getRequirement(httpServletRequest, serviceProviderId, requirementId);
