...
<body>
  ...
  <div class="container">
    ...
    %>
    <p><%=selectionDialog%> <a href="<%=request.getContextPath()%>/com/sample/rm/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">Sample Selector Dialog Client</a></p>
    <%}%>
    <%
    ...
    %>
    <p><%=creationDialog%> <a href="<%=request.getContextPath()%>/com/sample/rm/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">Sample Creation Dialog Client</a></p>
    <%}%>
    </div>
