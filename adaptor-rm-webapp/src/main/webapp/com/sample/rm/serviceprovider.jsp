...
End of user code
    ...
    (<a href="<%= request.getContextPath() %>/com/sample/rm/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
    ...
    (<a href="<%= request.getContextPath() %>/com/sample/rm/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
