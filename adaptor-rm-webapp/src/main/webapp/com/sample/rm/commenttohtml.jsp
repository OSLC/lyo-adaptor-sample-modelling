...
if (request.getParameter("resourceUri") != null) {
    aResource = new Comment (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aComment") != null) {
        aResource = (Comment) request.getAttribute("aComment");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Comment Resource} - update Comment.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
