...
<div class="container">
  ...
  <div class="page-header">
    <h1>Creation Dialog sample client</h1>
  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-primary">
        <div class="panel-heading">Creation Dialog iframe for:</div>
        <div class="panel-footer">
          <p><em style="word-wrap:break-word;"><%= creationDialogUri %></em></p>
        </div>
  ...
  $(function () {
      ...
      function presentOslcCreation(resourceUrl, resourceLabel) {
          ...
          previewLinks.on("show.bs.popover", function () {
              ...
              getUiPreviewIframe(resourceUrl, attachIframeToHyperlinkElement, uiElem);
            })
      }
