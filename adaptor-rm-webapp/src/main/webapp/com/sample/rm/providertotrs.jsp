...
<%@page import="com.sample.rm.resources.ProviderToTRS"%>

<%@ page contentType="text/html" language="java" pageEncoding="UTF-8" %>

<%
  ProviderToTRS aProviderToTRS = (ProviderToTRS) request.getAttribute("aProviderToTRS");
%>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <title><%= aProviderToTRS.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>ProviderToTRS resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aProviderToTRS.getAbout() %>"><%= aProviderToTRS.getAbout() %></a>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">TRS</dt>
            <dd class="col-sm-9"><%= aProviderToTRS.tRSToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">serviceProvider</dt>
            <dd class="col-sm-9"><%= aProviderToTRS.serviceProviderToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
