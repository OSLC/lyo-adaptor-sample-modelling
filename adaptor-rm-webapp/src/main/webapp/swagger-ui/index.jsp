    ...
    <%}else{%>
        ...
        <div class="container">
            <div class="alert alert-primary" role="alert">
                ...
                <hr>
                <p><strong>You don't seem to have configured your project to use a local standalone distribution of Swagger UI!</strong></p>
                <ul>
                    <li>A "dist" folder containing the Swagger UI collection of HTML, Javascript, and CSS assets is expected.</li>
