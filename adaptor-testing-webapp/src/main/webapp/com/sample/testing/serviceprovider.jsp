...
<body>
  ...
  <div class="container">
    ...
    (<a href="<%= request.getContextPath() %>/com/sample/testing/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
    ...
    (<a href="<%= request.getContextPath() %>/com/sample/testing/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">sample client</a>)
    </p>
    <%}%>
