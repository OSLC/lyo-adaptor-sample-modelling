...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - Testing Tool OSLC Adapter</title>
...
End of user code
  ...
  <div class="container">
    <div class="page-header">
      <h1>Testing Tool Service Provider Catalogue</h1>
    </div>
    <%--
...
<p>Modify the method getServiceProviderInfos() in the class TestingToolManager, to return the expected ServiceProvider resources.
</strong></em>
    <%--
End of user code
    --%>
