...
<%@page import="com.sample.testing.resources.TestCase"%>
<%--
...
<html>
  <head>
    ...
    <title><%= aTestCase.toString(true) %></title>
    <%--
...
End of user code
        ...
        <p>Summary: <%= aTestCase.toHtml() %><br /></p>
        <h2>Properties</h2>
        <table style="clear: both;">
          <tr>
            <td><%= aTestCase.usesToHtml()%></td>
          </tr>
          <tr>
            <td><%= aTestCase.titleToHtml()%></td>
          </tr>
          <tr>
            <td><%= aTestCase.contributorToHtml()%></td>
          </tr>
        </table>
      </div>
    </div>
